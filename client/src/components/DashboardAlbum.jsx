...
const DashboardAlbum = () => {
  ...
  return (
    <div className="w-full p-4 flex items-center justify-center flex-col">
      <div className="relative w-full gap-3  my-4 p-4 py-12 border h-screen border-gray-300 rounded-md flex flex-wrap justify-evenly">
        {allAlbums &&
...
export const AlbumCard = ({ data, index }) => {
  ...
  return (
    <motion.div
      ...
      className="relative  overflow-hidden w-44 h-1/3 min-w-180 px-2 py-4 gap-3 cursor-pointer hover:shadow-xl hover:bg-card bg-gray-100 shadow-md rounded-lg flex flex-col items-center"
    >
      <img
        src={data?.imageURL}
